...
path = 'F:\workingData\\201803\loan_data\medium'
file_name = '/test_mingj.csv'
out_file_path = path
out_file_name = 'over_due_sum.csv'


overdue_produce_based_on_score(path,file_name=file_name,out_file_path=out_file_path,
                               out_file_name=out_file_name,min=50,max=85,split_range=10)
